...
public interface ILicenseService
{
    ...
    Task<LicenseInfo?> GetLicenseAsync(string userId);
    ...
    Task<bool> HasValidLicenseAsync(string userId);
    ...
    Task<bool> ValidateLicenseAsync(string userId);
    ...
    Task<string> CreateCheckoutSessionAsync(string userId, string userEmail, string priceId, string successUrl, string cancelUrl);
